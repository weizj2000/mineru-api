...
if __name__ == '__main__':
    ...
    model_dir = snapshot_download('opendatalab/PDF-Extract-Kit-1.0', allow_patterns=mineru_patterns, cache_dir="models")
    layoutreader_model_dir = snapshot_download('ppaanngggg/layoutreader', cache_dir="models")
